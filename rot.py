...
#配置参数=============================================================。
domains=["amanochristianschool.org"] #需要注册的域名，你要是不填肯定注册不到
st=datetime.datetime.strptime("2015-09-28 21:30:00","%Y-%m-%d %H:%M:%S") #配置注册域名时间，别把时间设置到下个月就行
#配置参数=============================================================。
    ...
    def run(self):
        ...
        while 1 :
            ...
            try :
                ...
                browser.get("http://comin.supersite2.myorderbox.com/domain-registration/bulk-domain-registration.php")
