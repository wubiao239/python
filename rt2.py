...
#配置参数=============================================================。
domains=["globalvisa.in","rmm.org.in","decentgroup.in","gadgetindia.in"] #需要注册的域名，最好三个以内，你要是不填肯定注册不到

st=datetime.datetime.strptime("2015-09-21 03:55:00","%Y-%m-%d %H:%M:%S") #配置注册域名时间，别把时间设置到下个月就行
#配置参数=============================================================。
...
class regThread(threading.Thread):
    ...
    def run(self):
        ...
        try :
            ...
            print("没有安装PhantomJS浏览器，浏览器版本过低，也可能被杀毒软件阻止")
        ...
        def login(username,password):
            while 1 :
                try :
                    ...
                    print("矮油网速太渣，",self.domain,"登录失败，重新登录！")
                    time.sleep(0.5)
