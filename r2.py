...
#配置参数=============================================================。
domains=["shtc.in"] #需要注册的域名，最好三个以内，你要是不填肯定注册不到
st=datetime.datetime.strptime("2015-12-04 03:55:00","%Y-%m-%d %H:%M:%S") #配置注册域名时间，别把时间设置到下个月就行
    ...
    while 1 :
        ...
        for i in domains:
            try :
                ...
                browser.find_element_by_css_selector(".primary-result-section .primary-result:nth-child(1) button.select-domain").click()
